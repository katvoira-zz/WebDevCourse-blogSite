...
app.get("/", function(req, res) {
    Post.find({}, function(err, foundItems){
        res.render("home", {homeStartingContent: homeStartingContent.body, posts: foundItems});
...
app.get("/contact", function(req, res) {
    res.render("contact", {
        contactContent: contactContent.body
    });
});
...
app.post("/compose", function(req, res) {
    const post = new Post({
        ...
        summary: _.truncate(req.body.postBody, {'length': 100})
    });
    post.save();
    res.redirect("/");
});
